...
| `scripts/plot_long_context.py` | renders `assets/long_context_table.png` from `results/long_context_multilingual.json` |
...
| `results/long_context_multilingual.json` | the long-document run behind `assets/long_context_table.png`: every prediction, with device and library versions |
